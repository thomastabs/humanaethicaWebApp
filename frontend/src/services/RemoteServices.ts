...
export default class RemoteServices {
  ...
  static async createEnrollment(enrollment: Enrollment, activityId: number) {
    return httpClient
  ...
  static async createParticipation(participation: Participation, activityId: number) {
    return httpClient
  ...
  static async createAssessment(assessment: Assessment, institutionId: number) {
    return httpClient
